...
export type VariantOptionsSnapshot = {
    [group: string]: string;
};
...
export type ShippingMethodSnapshot = Pick<ShippingMethod, 'name' | 'carrier'> & { estimated_days: number };
...
// ----------------------------------------------------------------------------
export type TransactionType = "PAYMENT" | "REFUND" | "MANUAL";
export type DisputeStatus = "OPEN" | "RESOLVED" | "LOST";
...
export type WebhookLogStatus = "RECEIVED" | "PROCESSED" | "FAILED" | "IGNORED";
...
export type DisputeNotificationData = {
...
export type ClientCodeNotificationData = {
...
export type OtherNotificationData = {
...
export type LandingBlock<Content = unknown> = {
    id: number;
